                ...
                @SqlResultSetMapping(
                        ...
                        classes = @ConstructorResult(
                                ...
                                columns = {
                                        ...
                                        @ColumnResult(name = "Color_vn", type = Integer.class),
...
@NamedNativeQuery(
        ...
        query = "SELECT od.id, od.total_price, od.Color Color_vn, p.name product_name, (p.images ->> '$[0]') as product_img " +
                "FROM orders od " +
...
@NamedNativeQuery(
        ...
        query = "SELECT orders.id, orders.total_price, orders.Color Color_vn, product.name product_name, orders.price as product_price, " +
