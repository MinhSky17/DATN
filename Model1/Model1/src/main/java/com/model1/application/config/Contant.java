package com.model1.application.config;
...
public class Contant {
    ...
    //Color giày
    public static final List<Integer> Color_VN = new ArrayList<>(Arrays.asList(35, 36, 37, 38, 39, 40, 41, 42));
    public static final double[] Color_US = {2.5, 3.5, 4.5, 5.5, 6.5, 7.5, 8.5, 9.5};
    public static final double[] Color_CM = {21.3, 22.2, 23, 23.8, 24.6, 25.4, 26.2, 27.1};
