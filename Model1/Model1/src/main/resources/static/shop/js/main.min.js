!function (e) {
    ...
    var t = {
        initialised: !1, mobile: !1, init: function () {
            ...
            t(), e.fn.smartreColor ? e(window).smartreColor(t) : e(window).on("reColor", t)
            ...
            setTimeout(s, 500), e(window).smartreColor(s), e(window).on("scroll", s)
            ...
            i.length && i.each(function () {
                ...
                if (c.css({
                    ...
                    e(window).on("scroll reColor", p), p()
                } else i.addClass("parallax-disabled")
            })
        }, isotopes: function () {
            var t = {
                itemsSelector: ".grid-item",
                masonry: {columnWidth: ".grid-col-Colorr"},
                percentPosition: !0,
            ...
            e(".grid").each(function () {
                ...
                if (n.sortReorder) {
                    ...
                    e.fn.smartreColor ? e(window).smartreColor(a) : e(window).on("reColor", a)
                }
            })
        }, zoomImage: function () {
